...
namespace dae {
	...
	Matrix Matrix::CreateRotationX(float pitch)
	{
		...
		Vector4 yRow{ Vector4{0, cos(pitch), -sin(pitch), 0} };
		Vector4 zRow{ Vector4{0, sin(pitch), cos(pitch), 0} };
		Vector4 tRow{ Vector4{0, 0, 0, 1} };
	...
	{
		//todo W2
		Vector4 xRow{ Vector4{cos(yaw), 0, -sin(yaw), 0} };
		Vector4 yRow{ Vector4{0, 1, 0, 0} };
		Vector4 zRow{ Vector4{sin(yaw), 0, cos(yaw), 0} };
		Vector4 tRow{ Vector4{0, 0, 0, 1} };
	...
	{
		//todo W2
		Vector4 xRow{ Vector4{cos(roll), sin(roll), 0, 0} };
		Vector4 yRow{ Vector4{-sin(roll),cos(roll), 0, 0} };
	...
	{
		//todo W2
		Vector4 xRow{ Vector4{sx, 0, 0, 0} };
		Vector4 yRow{ Vector4{0, sy, 0, 0} };
		Vector4 zRow{ Vector4{0, 0, sz, 0} };
		Vector4 tRow{ Vector4{0, 0, 0, 1} };
